...
2. Ядро выполняет поиск не занятой позиции в таблице открытых файлов ядра. Если свободная позиция найдена, то в найденную запись таблицы открытых файлов процесса заносится ссылка на найденную запись таблицы ядра.
