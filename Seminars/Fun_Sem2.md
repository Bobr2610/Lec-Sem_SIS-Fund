...
Вот обновленный вариант с фигурными скобками, оформленными в точности как на рукописном изображении:
...
Вот текстовая расшифровка записей с нового изображения, переведенная в формат LaTeX, с сохранением структуры конспекта:
